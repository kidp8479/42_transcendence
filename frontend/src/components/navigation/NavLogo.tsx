...
export function NavLogo({ to }: NavLogoProps) {
  return (
    ...
    >
      <span className="grid h-10 w-10 place-items-center rounded-xl border border-brand-500/30 bg-brand-transparent/10 shadow-sm shadow-brand-500/10 transition group-hover:border-brand-500/60 group-hover:bg-brand-500/15">
